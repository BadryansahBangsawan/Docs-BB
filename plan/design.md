...
```
# Personal Docs - Design Direction

## Product Feel

The site should feel like a focused documentation workspace: quiet, structured, fast to scan, and useful for repeated reading.

## Layout

- Sticky top header with site identity, search trigger, theme toggle, and mobile navigation trigger.
- Persistent left sidebar on desktop.
- Slide-in sidebar on mobile.
- Main content width stays constrained for readable line length.
- Documentation pages use a two-column desktop layout with page content and an "On this page" rail.

## Visual System

- Neutral surface colors with blue primary accents and green secondary accents.
- Cards use a small radius and thin borders.
- Typography is compact and readable, with large type reserved for page titles only.
- Code blocks and inline code use muted backgrounds and monospace text.

## Interaction

- Search opens from the header or `Cmd/Ctrl + K`.
- Search indexes document titles, descriptions, categories, and headings.
- Dark and light modes are available from the header.
- Navigation links must preserve the planned URL structure.

## Content Pattern

Each documentation page uses frontmatter for:
...
Markdown content should use headings, short paragraphs, lists, quotes, and code blocks.
